    ...
    <div class="item-detail-show">
      <div class="item-detail-left">
        <div class="item-detail-big-img">
          <pic-zoom :previewImg="goodsInfo.goodsImg[imgIndex]" :zoomImg="goodsInfo.goodsImg[imgIndex]"></pic-zoom>
      ...
      <div class="item-detail-right">
        <div class="item-detail-title">
          <p>
            <span class="item-detail-express">京东配送</span> {{goodsInfo.title}}</p>
        </div>
