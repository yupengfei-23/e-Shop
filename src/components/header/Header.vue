    ...
    <div class="nav">
      ...
      <ul class="detail">
        <li class="first" v-show="!userInfo.username">
          您好，请<router-link to="/login">登录 <Icon type="person"></Icon></router-link> |<span class="text-color-red"><router-link to="/SignUp">免费注册 <Icon type="person-add"></Icon></router-link></span>
        </li>
